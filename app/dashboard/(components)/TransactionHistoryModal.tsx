...
import { useDashboard, Transaction } from '../DashboardContext'
                ...
                <Box sx={{ 
                  ...
                  <Box 
                    sx={{ 
                      ...
                      padding: '2px 8px',
                      borderRadius: '4px',
                      backgroundColor: transaction.type === 'subscription' ? 'rgba(119, 94, 255, 0.1)' : 'rgba(255, 94, 191, 0.1)',
                      display: 'inline-flex'
                    }}
                  >
                    <Typography variant="caption" sx={{ 
                      color: transaction.type === 'subscription' ? '#775EFF' : '#FF5EBF',
                      fontFamily: 'JetBrains Mono',
                      fontSize: '11px',
